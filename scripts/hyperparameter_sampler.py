...
a_sets = ['hayes-roth', 'tae', 'haberman', 'newthyroid', 'bupa', 'wine', 'balancescale', 'bloodtransfusion', 'heart', 'cleveland', 'mammographic', 'banknotes', 'pima', 'tictactoe', 'australian', 'spectfheart', 'car', 'vowel', 'contraceptive', 'diabetic', 'soybean', 'syntheticcontrol', 'segment', 'artificialcharacters', 'chess', 'thyroid', 'turkiye', 'waveform', 'magic']
b_sets = ['iris', 'breast', 'monk-2', 'led7digit', 'saheart', 'wisconsin', 'titanic', 'crx', 'creditapproval', 'ionosphere', 'sonar', 'flare', 'dermatology', 'banana', 'vehicle', 'wdbc', 'german', 'phoneme', 'seismicbumps', 'drugconsumption', 'page-blocks', 'steelfaults', 'krvskp', 'ring', 'twonorm', 'penbased', 'splice', 'texture', 'spambase']

template = 'java -Xmx6G -jar ednel.jar --datasets_path keel_datasets_10fcv ' \
           '--metadata_path /A/henry/ednel/metadata/<experiment_set> --n_samples 1 --thinning_factor 0 --timeout 10000 --timeout_individual 60 --log ' \
